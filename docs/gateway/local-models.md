---
summary: "Run OpenClaw on local LLMs (LM Studio, vLLM, custom OpenAI endpoints)"
read_when:
...
vLLM, OAI-proxy, or custom gateways work if they expose an OpenAI-style `/v1` endpoint. Replace the provider block above with your endpoint and model ID:
